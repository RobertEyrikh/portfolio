...
const projects: projectType[] = [
  ...
  {
    name: "Nersisyan",
    description: "Сайт адвоката Нерсисяна Карена Георгиевича. Это landing page с формой обратной связи, реализованной через telegram бот. Приложение разработано с помощью Vue js. Использованы Bootstrap Vue в качестве UI фреймворка, библиотеки axios для асинхронных запросов и vuelidate. Приложение развернуто с помощью docker. В качестве веб сервера выступает Nginx.",
